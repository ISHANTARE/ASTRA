...
def test_line1_wrong_length():
    with pytest.raises(InvalidTLEError) as exc:
        parse_tle(
            "NAME",
            "1 25544U 98067A   21001.00000000  .00001480  00000-0  34282-4 0  999",
...
def test_line2_wrong_length():
    with pytest.raises(InvalidTLEError) as exc:
        parse_tle(
            ...
            "2 25544  51.6442 284.1199 0001364 338.5498  21.5664 15.48922536 1234",
        )
...
def test_bad_checksum_line1():
    ...
    with pytest.raises(InvalidTLEError) as exc:
        parse_tle(
            "NAME",
            "1 25544U 98067A   21001.00000000  .00001480  00000-0  34282-4 0  9991",
            "2 25544  51.6442 284.1199 0001364 338.5498  21.5664 15.48922536 12341",
        )
...
def test_bad_checksum_line2():
    ...
    with pytest.raises(InvalidTLEError) as exc:
        parse_tle(
            "NAME",
            "1 25544U 98067A   21001.00000000  .00001480  00000-0  34282-4 0  9990",
            "2 25544  51.6442 284.1199 0001364 338.5498  21.5664 15.48922536 12346",
        )
...
def test_line1_bad_start():
    ...
    with pytest.raises(InvalidTLEError) as exc:
        parse_tle(
            "NAME",
            "2 25544U 98067A   21001.00000000  .00001480  00000-0  34282-4 0  9995",
            "2 25544  51.6442 284.1199 0001364 338.5498  21.5664 15.48922536 12341",
        )
